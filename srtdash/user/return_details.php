...
$result1 = $conn->prepare("SELECT SUM(total) AS count FROM cart_bil where cstatus='done' and bil_no=".$id);
$result1->execute();
...
<table>
<tr>
<form action="returnsave.php" method="post">
<input type="number" name="b_id" value="<?php echo $row['bil']; ?>" style="display: none">
<tr><td>Address :- </td><td><textarea rows="5" cols="17" name="msg"></textarea> </td> </tr>
<tr><td><input type="submit" name="submit" class="btn btn-primary" value="return these product"></td>
<td><a href="return.php"><button class="btn btn-primary" type="button">Back</button></a></td></tr>
</form> 
