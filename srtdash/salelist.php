...
<?php include("header.php");?>
 ...
 <div class="card">
 <div class="card-body">
 <h4 class="header-title">Sale List</h4>
 <a href="SaleMaster.php"><button type="button" style="float:right;" class="btn 
btn-outline-primary mb-3">Add New</button></a>
 ...
 <tbody>
 <?php
 $result = $conn->prepare("SELECT * FROM sale_master ORDER BY id 
desc");
 $result->execute();
 ...
 if($row['cus_id']>0)
 {
 $resultcom = $conn->prepare("SELECT * From customer where 
id=".$row['cus_id']."");
 $resultcom->execute();
 ...
 <td><?php echo $row['payment']; ?></td>
    ...
    <td> <a href="saleEdit.php?ID=<?php echo $row['id']; ?>"><i class="ti-pencil"></i></a>
