...
$result=$conn->prepare("select * from feedback order by id asc");
$result->execute();
for($i=0;$row=$result->fetch();$i++)
{
    ...
    <td> <a href="feedmail.php?ID=<?php echo $row['id']; ?>"><i class="fa fa-envelope"></i></a>
...
txt = delid;
window.location.href="contdel.php?id="+ txt;
} else {
