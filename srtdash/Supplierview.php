...
<a href="Supplier.php"><button type="button" style="float:right;" class="btn btn-outline-primary mb-3">Add New</button></a>
...
for($i=0;$row=$result->fetch();$i++)
{
	...
	<td>
     <a href="supEdit.php?ID=<?php echo $row['id']; ?>"><i class="ti-pencil"></i></a>
...
txt = delid;
window.location.href="SupDelete.php?id="+ txt;
} else {
